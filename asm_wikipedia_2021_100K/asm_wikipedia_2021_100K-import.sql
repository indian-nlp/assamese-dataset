...
CREATE DATABASE `asm_wikipedia_2021_100K`;

USE `asm_wikipedia_2021_100K`;
...
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'asm_wikipedia_2021_100K-sources.txt' INTO TABLE sources;
